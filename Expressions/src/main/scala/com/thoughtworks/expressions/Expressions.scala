...
trait Expressions extends Debugging {
  ...
  /** @template */
  protected type ExpressionCompanion <: AnyRef

  @inject
  protected def ExpressionCompanion(): Implicitly[ExpressionCompanion]

  val Expression: ExpressionCompanion = ExpressionCompanion()
